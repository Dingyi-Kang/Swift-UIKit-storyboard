...
- [Animation, transition, presentation and other visual effect](Animation/)
  ...
  * [How to make animation launch view](AnimationTransitionPresentation/animLaunch.md)
  * [The View of Loading Animation](AnimationTransitionPresentation/loadingAnimation.md)
- [Alert](Alert/)
...
- [TableView](TableView/) 
  ...
  * [Dynamic height for tableView cells, headers and footers](TableView/dynamicHeight.md)
...
- [TextField/TextView](TextField&TextView/) 
  ...
  * [How to dismiss input keyboards programmatically](TextField&TextView/dismissKeyboard.md)
...
- [UINavigationController](UINavigationController/)
  ...
  * [!!!Configure NavBar Appearance globally and locally](UINavigationController/confiGlobaLocal.md)
  ...
  * [How to make a transparent navBar](UINavigationController/transparentNavBar.md)
...
- [Storyboard and Segue](Storyboard_segue/)
  ...
  * [How to not use VC in storyboard as initial VC and use a custom xib as initial VC instead](Storyboard_segue/customInitialVC.md)
...
- [Files and images](Files/)
  ...
  * [How to compress images](Files/compressImages.md)
...
- [Select Photos or Take Photos or Scan document](Photos/)
...
- [Swift Grammar](Swift_Grammar/)
  ...
  * [Configure a property in its initialization](Swift_Grammar/configurePropertyInitial.md)
...
- [App Deployment](App_deployment/)
  ...
  * [Internal tester vs external tester](https://www.youtube.com/watch?v=3aautA1kclE&t=463s)
...
- [Firebase](FireBase/) 
  ...
  * [How to handle errors of authentication provided by Firebase](FireBase/handleErrors.md)
